...
CREATE INDEX `isu__jia_user_id` ON `isu` (`jia_user_id`);
...
CREATE INDEX `isu_condition__jia_isu_uuid` ON `isu_condition` (`jia_isu_uuid`);
CREATE INDEX `isu_condition__timestamp` ON `isu_condition` (`timestamp`);
